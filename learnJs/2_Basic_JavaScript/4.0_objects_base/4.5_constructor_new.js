...
/**
 * Особенности this в конструкторах
 * Ключевое слово new задает особенность работы this в этих функциях, в результате чего this внутри имеет правильное значение
 */
 ...
 */
{
    ...
    let u3 = new User; // тоже самое что и new User(). Но так не принято
}
