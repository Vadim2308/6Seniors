...
/**
 * при преобразовании к строке вернет [object Object]
 * при преобразовании к числу вернет NaN
 */
...
}
{
    ...
    if (user == 1) { ... };
    {
        const obj = {};
        const obj2 = {};
        const str = String(obj); //[object Object]
...
/**
 * toString/valueOf
 * Для хинта "string": вызвать метод toString, а если он не существует (или равен null, undefined) или возвращает объект вместо примитивного значения, то valueOf
 * Для других хинтов: вызвать метод valueOf, а если он не существует (или равен null, undefined) или возвращает объект вместо примитивного значения, то toString
 */
...
/**
 * Особенность.
 * obj[{}] => вызывается Symbol.toPrimitive, и он уже рулит хинтом
 * obj[{}.toString()] => вызывается напрямую, без SymbolPrimitive
 */