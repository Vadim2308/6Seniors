/**
 * Links:
     * 1.https://www.youtube.com/watch?v=ntwLUBjOi8U
 */

/**
 * Прототип - это прежде всего объект, и механизм, который используется для наследования свойств и методов между объектами в JavaScript.
 ...
 */
{
    ...
    // Однако если мы не указываем __proto__  в объекте, цикл по прототипу не пройдет. Т.е. для обхода прототипа должен быть установлен __proto__
    {
