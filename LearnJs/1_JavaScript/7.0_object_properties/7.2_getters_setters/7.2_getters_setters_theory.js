 ...
 */
{
    ...
    Object.defineProperty(user, 'fullName', {
        // не можем тут писать writable и value свойство объекта может быть либо свойством-аксессором (с методами get/set) либо свойством-данным (со значением value)
        // Eсли в дескрипторе есть ключи [value или writable] и [get или set], генерируется исключение.
        // configurable и enumerable мы можем использовать и там и там
        get() {
            return `${this.name} ${this.surname}`;
        },
