 ...
 * (!) использовать this ДО вызова super приведет к ошибке! this появится только после вызова конструктора родителя
 */
{
    class Animal {
        constructor(name) {
...
}
{
    ...
    /**
     * Почему не работает ?
     *  1. В наследующем классе (т.е.тот который наследует свойства и методы родителя) соответствующая функция-конструктор помечена специальным внутренним свойством [[ConstructorKind]]:"derived(производный)"
