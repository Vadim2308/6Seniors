...
0 == '01' // false (нули у строки вначале откидываются. Даже если 0000000001)
"aaa" > "aaa " // false, т.к. справа есть элемент, а слева нет.
...
undefined == null // true. При нестрогом равно null == null || null == undefined (Особенность, указано в спеке)
